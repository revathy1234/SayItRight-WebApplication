<body background="home-banner.jpg" style="overflow: scroll;visibility: visible">
	<?php echo form_open('AddConference_controller/form/uri'); ?>
	<form method="post">
		<pre>
		<input type="text" name="name" placeholder="Enter conference name">
		<input type="text" name="desc" placeholder="Enter conference description">

		<input type="text" size="10%" name="loc" placeholder="Enter conference location">
